def float_to_ieee754_32bit(value):
    if value == 0.0:
        return '0' * 32
    if value == float('inf'):
        return '0' * 8 + '11111111' + '00000000000000000000000'
    if value == float('-inf'):
        return '1' * 8 + '11111111' + '00000000000000000000000'
    if value != value: 
        return '0' * 8 + '11111111' + '10000000000000000000000'
